...
水色の面積にあたります。先述したように、このくらいの範囲では $g$ の値が大きく変化しませんから、物体に働く重力 $mg$ と高さ $h$ の積としても、本来の位置エネルギーの大きさから大きく外れないわけです。実際に重力加速度 $g=9.8\;\mathrm{m/s^2}$ として計算すると
$$
