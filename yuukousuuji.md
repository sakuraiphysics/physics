...
　しかし，完全にこうだ！ というルールを示せない曖昧な状況でもあるし，全ての文書が科学的に誠実な記法を採用しているわけではない．その値が計算結果で，そこまでの計算過程が記されているなら，そこから読み取って解釈もできるだろうが，測定値などでポッとこのような値が出てきた時には，有効桁の判断のしようがない．そのような場合は，結局のところ文脈から判断するしかない．
