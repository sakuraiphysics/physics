...
　以上より，本文内で示した通り，完全にこうだ！ というルールを示せない曖昧な状況であると言えよう．その値が計算結果で，そこまでの計算過程が記されているなら，そこから読み取って解釈もできるだろうが，測定値などでポッとこのような値が出てきた時には，有効桁の判断のしようがない．そのような場合は，結局のところ文脈から判断するしかない．

　ただ，上に記したように，日本では末尾の0を有効数字に含めるとするのが一般的で，それを推奨しているふしがある．だから，参考書や問題集でそのような表記をみかけたら，末尾の0は有効数字として考えるのがよいだろう．
